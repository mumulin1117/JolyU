...
class TOWINKLIopPortalViewController: UIViewController {
    ...
    private let TOWINKLIopFestiveBackground: UIImageView = {
        ...
        TOWINKLIopView.image = TOWINKLIopMediaVaultDecoder.TOWINKLIopFetchVibeGraphic(TOWINKLIopAssetAlias: "TOWINKLIop_Login_Bg")
    ...
    private let TOWINKLIopEulaTrigger: UIButton = {
        ...
        TOWINKLIopBtn.setBackgroundImage(TOWINKLIopMediaVaultDecoder.TOWINKLIopFetchVibeGraphic(TOWINKLIopAssetAlias: "ELUATOWINKLIop"), for: .normal)
    ...
    private let TOWINKLIopAppSlogan: UIImageView = {
        let TOWINKLIopLabel = UIImageView.init(image: TOWINKLIopMediaVaultDecoder.TOWINKLIopFetchVibeGraphic(TOWINKLIopAssetAlias: "Martin Randolph"))
    ...
    private let TOWINKLIopConsentRadio: UIButton = {
        ...
        TOWINKLIopBtn.setImage(TOWINKLIopMediaVaultDecoder.TOWINKLIopFetchVibeGraphic(TOWINKLIopAssetAlias: "TOWINKLcheckmar"), for: .normal)
        TOWINKLIopBtn.setImage(TOWINKLIopMediaVaultDecoder.TOWINKLIopFetchVibeGraphic(TOWINKLIopAssetAlias: "TOWINKLcheckmarfill"), for: .selected)
