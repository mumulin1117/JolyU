...
class TOWINKLIopRoomCardCell: UICollectionViewCell {
    lazy var TOWINKLIoCellpbg: UIImageView = {
        ...
        TOWINKLIopuserlip.image = UIImage(named: "TOWINKLIoCellpbg")
    ...
    lazy var TOWINKLIopalert: UIButton = {
        ...
        TOWINKLIopuserlip.setImage(UIImage.init(named: "TOWINKLIopalert"), for: .normal)
        TOWINKLIopuserlip.translatesAutoresizingMaskIntoConstraints = false
        return TOWINKLIopuserlip
    }()
    ...
    lazy var TOWINKLIojoinButton: UIButton = {
        let TOWINKLIopuserlip = UIButton()
        TOWINKLIopuserlip.setBackgroundImage(UIImage.init(named: "TOWINKLIojoinButton"), for: .normal)
