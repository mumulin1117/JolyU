...
//    private let TOWINKLIopPaperBackground = UIView()
    ...
    lazy var TOWINKLIocomment: UIImageView = {
        ...
        TOWINKLIopuserlip.translatesAutoresizingMaskIntoConstraints = false
        TOWINKLIopuserlip.contentMode = .scaleToFill
        TOWINKLIopuserlip.image = TOWINKLIopMediaVaultDecoder.TOWINKLIopFetchVibeGraphic(TOWINKLIopAssetAlias: "TOWINKLIoAcomment")
        return TOWINKLIopuserlip
    }()
    ...
    lazy var TOWINKLIoAlertButton: UIButton = {
     ...
     let TOWINKLIopVibeLabel = UILabel()
    ...
    private func TOWINKLIopLayoutVideo() {
        TOWINKLIopAuthorAvatar.layer.cornerRadius = 19
        ...
        TOWINKLIoCellpbg.addSubview(TOWINKLIoVideopbg)
        TOWINKLIoCellpbg.addSubview(TOWINKLIopAuthorAvatar)
        TOWINKLIoCellpbg.addSubview(TOWINKLIopUsername)
        
        TOWINKLIoCellpbg.addSubview(TOWINKLIopraise)
        TOWINKLIoCellpbg.addSubview(TOWINKLIocomment)
        
        TOWINKLIoCellpbg.addSubview(TOWINKLIoAlertButton)
...
//        TOWINKLIopVibeLabel.text = "Join our live chat to find Christmas photo buddies and share pro tips 📸"
        ...
        NSLayoutConstraint.activate([
            ...
            TOWINKLIoVideopbg.topAnchor.constraint(equalTo: TOWINKLIoCellpbg.topAnchor,constant: 10),
            TOWINKLIoVideopbg.leadingAnchor.constraint(equalTo: TOWINKLIoCellpbg.leadingAnchor,constant: 10),
            TOWINKLIoVideopbg.trailingAnchor.constraint(equalTo: TOWINKLIoCellpbg.trailingAnchor,constant: -58),
            TOWINKLIoVideopbg.bottomAnchor.constraint(equalTo: TOWINKLIoCellpbg.bottomAnchor,constant: -54),
            ...
            TOWINKLIopAuthorAvatar.rightAnchor.constraint(equalTo: TOWINKLIoCellpbg.rightAnchor,constant: -10),
            ...
            TOWINKLIopraise.trailingAnchor.constraint(equalTo: TOWINKLIoCellpbg.trailingAnchor,constant: -10),
            TOWINKLIopraise.topAnchor.constraint(equalTo: TOWINKLIopAuthorAvatar.bottomAnchor, constant: 42),
            TOWINKLIopraise.widthAnchor.constraint(equalToConstant: 26),
            TOWINKLIopraise.heightAnchor.constraint(equalToConstant: 26),
            
            TOWINKLIocomment.trailingAnchor.constraint(equalTo: TOWINKLIoCellpbg.trailingAnchor,constant: -10),
            TOWINKLIocomment.topAnchor.constraint(equalTo: TOWINKLIopraise.bottomAnchor, constant: 28),
            TOWINKLIocomment.widthAnchor.constraint(equalToConstant: 26),
            TOWINKLIocomment.heightAnchor.constraint(equalToConstant: 26),
            
            TOWINKLIoAlertButton.trailingAnchor.constraint(equalTo: TOWINKLIoCellpbg.trailingAnchor,constant: -10),
            ...
            TOWINKLIopVibeLabel.trailingAnchor.constraint(equalTo: TOWINKLIoCellpbg.trailingAnchor,constant: -10),
            TOWINKLIopVibeLabel.leadingAnchor.constraint(equalTo: TOWINKLIoCellpbg.leadingAnchor,constant: 10),
